...
DATA_AOI_DICT = {
    "Lake_erie": ee.Geometry.Polygon(
        [
            [
                [-83.70830078125002, 40.95048250364204],
                [-78.46782226562502, 40.95048250364204],
                [-78.46782226562502, 43.08055780651552],
                [-83.70830078125002, 43.08055780651552],
                [-83.70830078125002, 40.95048250364204],  # Closing the polygon
            ]
        ]
    ),
    "Lake_garda": ee.Geometry.Polygon(
        [
            [
                [10.392955737175216, 45.363718171972664],
                [10.977977709831466, 45.363718171972664],
                [10.977977709831466, 45.91293738272485],
                [10.392955737175216, 45.91293738272485],
                [10.392955737175216, 45.363718171972664],  # Closing the polygon
            ]
        ]
    ),
    "Lake_Geneva": ee.Geometry.Polygon(
        [
            [
                [6.0502108634111185, 46.18952924333032],
                [7.0183810294267435, 46.18952924333032],
                [7.0183810294267435, 46.54299484144756],
                [6.0502108634111185, 46.54299484144756],
                [6.0502108634111185, 46.18952924333032],  # Closing the polygon
            ]
        ]
    ),
}
